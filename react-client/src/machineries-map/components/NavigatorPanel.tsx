...
import {FiChevronLeft, FiFileText, FiGift, FiGrid, FiLock} from "react-icons/fi";
                            ...
                            Array.from(props.machineries.entries()).map((entry) => (
                                <Fragment key={entry[0]}>
                                    <VStack
                                        ...
                                        onClick={() => (handleClusterLocationClicked(entry[0]))}
                                    >
                                        <HStack>
                                            <VStack>
