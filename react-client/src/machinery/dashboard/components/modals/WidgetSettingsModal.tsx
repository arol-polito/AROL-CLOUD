    ...
    return (
        ...
        >
            ...
            >
                    ...
                    >
                        {
                            ...
                            >
                                ...
                                <HStack w={"full"} mx={8} justifyContent={"center"}>
                                    ...
                                    <Input w={75} type={"number"} value={sensorsMonitoring.dataRange.amount} onChange={handleRangeAmountChanged}/>
                                ...
                                >
...

                                    {
                                        sensorsMonitoring.aggregations.map((value, index) => (
                                            ...
                                            >
                                                <HStack w={"full"}>
                                                    <Text fontSize={"md"} whiteSpace={"nowrap"}>Aggregation {props.maxSelectableSensors===1 ? "type" : index + 1}</Text>
                ...
                <ModalFooter>
                    <Button mr={3} onClick={() => (props.setSettingsModalOpen(false))}>Discard changes</Button>
