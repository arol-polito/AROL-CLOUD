...
function MultiValueDataDisplay(props: MultiValueDataDisplay) {
    ...
    function handleChartWheel(e: React.WheelEvent<HTMLDivElement>) {

        return;

        e.stopPropagation()

        // if (!chartActiveLabel) return
        //
        // setChartZoom({
        //     doZoom: true,
        //     pivotIndex: chartActiveLabel.activeTooltipIndex,
        //     zoomAmount: ~~(e.deltaY / 100) * 3
        // })
                    ...
                    <>
                        ...
                        >
                            <Text
                                ...
                                fontWeight={400}
                            >
                                {props.sensorData.displayData.length ? props.sensorData.displayData[0].formattedTime : ""} {props.sensorData.leftData.length === 0 ? "(end)" : ""}
                            </Text>
                            <Text
                                w={"full"}
                                textAlign={"center"}
                            ...
                            <Text
                                ...
                                fontWeight={400}
                            >
                                {props.sensorData.displayData.length ? props.sensorData.displayData.slice(-1)[0].formattedTime : ""} {props.sensorData.rightData.length === 0 ? "(end)" : ""}
                            </Text>
                        </HStack>
                        {
